...
public class TestListener implements ITestListener {
	 ...
	 * " failed..."); // log.info((result.getMethod().getMethodName() +
	 * " failed!"));
	 * 
	 ...
	 * + "screenshots"; // log.info("Screen shots reports path - " + reportsPath);
	 * try { File file = new File(reportsPath + fileSeperator + testClassName); //
	 * Set // screenshots // folder if (!file.exists()) { if (file.mkdirs()) { //
